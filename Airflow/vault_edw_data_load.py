...
with DAG(
    ...
    with TaskGroup("integration_group") as integration_group:
        ...
        exec_Honk_Daily_Feed = TriggerDagRunOperator(
            task_id="exec_Honk_Daily_Feed",
            trigger_dag_id="Honk_Daily_Feed",
            dag=dag,
        )

        exec_current_carrier_auto_daily_feed = TriggerDagRunOperator(
            task_id="exec_current_carrier_auto_daily_feed",
            trigger_dag_id="current_carrier_auto_daily_feed",
            dag=dag,
        )
