...
with DAG(
    ...
    with TaskGroup("vendor_report_group") as vendor_report_group:
        ...
        sp_tvendor_report_stage_data >> sp_tvendor_report_AonCatStore >> sp_tvendor_report_CarfaxMileage >> sp_tvendor_report_CarfaxValue >> sp_tvendor_report_CLUEAuto >> sp_tvendor_report_GuyCarpenter >> sp_tvendor_report_IsoVehicle >> sp_tvendor_report_IsoProperty >> sp_tvendor_report_LC360 >> sp_tvendor_report_MVR >> sp_tvendor_report_NHTSA >> sp_tvendor_report_TransUnion >> sp_tvendor_report_SAQ >> sp_tvendor_report_hazardhub >> sp_tvendor_report_clue_property >> send_vendor_report_email
