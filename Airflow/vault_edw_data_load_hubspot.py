...
with DAG(
    dag_id='vault_edw_data_load_hubspot',
    catchup=False,
    max_active_runs=1,
    default_args=args,
    ...
    with TaskGroup("hubspot_group") as hubspot_group:
        ...
        operators = []
        for item in hubspot_group_items:
        ...
        send_hubspot_email = EmailOperator(
            ...
            to=to_email,
            subject='Airflow - Hubspot tables loaded successfully',
            html_content=get_sp_success_data_HTML(hubspot_group_items, 'All stored procedures executed successfully for all the Hubspot tables'),
        )
