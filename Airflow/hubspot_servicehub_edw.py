...
SSH_HOME = f'/home/{Hubspot_VM_USERNAME}/hs-servicehub-edw'
REMOTE_ENV_PATH = f'{SSH_HOME}/.env'
REMOTE_RUN_CMD  = f'bash {SSH_HOME}/run_servicehub.sh '
...
with DAG(
    dag_id='hubspot_servicehub_edw',
    catchup=False,
    max_active_runs=1,
    default_args=args,
    start_date=pendulum.datetime(2025, 5, 27, tz="America/New_York"),
...
""",
    ...
    run_hs_servicehub_edw_script = SSHOperator(
        task_id='run_hs_servicehub_edw_script',
        ssh_conn_id='ssh_vm_hubspot',
    ...
    start >> write_remote_env >> run_hs_servicehub_edw_script >> end
