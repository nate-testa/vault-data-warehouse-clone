...
-- Unique Key: quote_no, effective_dt, transaction_seq_no

--1) Drop temp tables
DROP TABLE IF EXISTS edw_temp.tquote_home_coverage_backfill_temp1;
...
select 
	...
	IssuedDate
into edw_temp.tquote_home_coverage_backfill_temp1
from source_data_2
;
...
FROM edw_core.tquote_home_coverage a
LEFT JOIN edw_temp.tquote_home_coverage_backfill_temp1 b
...
SELECT TOP 10 * FROM edw_core.tquote_home_coverage t
