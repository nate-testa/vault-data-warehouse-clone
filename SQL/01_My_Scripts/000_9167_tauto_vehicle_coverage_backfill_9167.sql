...
--1) Drop table
DROP TABLE IF EXISTS edw_temp.tauto_vehicle_coverage_backfill_temp1;
DROP TABLE IF EXISTS edw_temp.tauto_vehicle_coverage_backfill_temp2;
DROP TABLE IF EXISTS edw_temp.tauto_vehicle_coverage_backfill_temp3;
;
...
INTO edw_temp.tauto_vehicle_coverage_backfill_temp1
...
AND acctvpf.Coverage IN ('Underinsured Motorist','Added First Party','Added Personal Injury Protection','Basic First Party','Customized','Fire','Property Protection Insurance','Theft','Uninsured Bodily Injury','Uninsured Property Damage','Uninsured Motorist')
AND p.[Name] = 'Automobile'
AND p.ProductLine = 'PersonalLines'

SELECT * 
INTO edw_temp.tauto_vehicle_coverage_backfill_temp2
FROM (
	SELECT PolicyNumber, EffectiveDate, IssuedDate, policychangenumber, ObjectUniqueId, CONCAT(FinalColumnName, '_method') AS FinalColumnName, method           as FinalValue FROM edw_temp.tauto_vehicle_coverage_backfill_temp1 WHERE method IS NOT NULL
	UNION ALL
	SELECT PolicyNumber, EffectiveDate, IssuedDate, policychangenumber, ObjectUniqueId, CONCAT(FinalColumnName, '_amount') AS FinalColumnName, amount           as FinalValue FROM edw_temp.tauto_vehicle_coverage_backfill_temp1 WHERE amount IS NOT NULL
	UNION ALL
	SELECT PolicyNumber, EffectiveDate, IssuedDate, policychangenumber, ObjectUniqueId, CONCAT(FinalColumnName, '_retention') AS FinalColumnName, [retention]   as FinalValue FROM edw_temp.tauto_vehicle_coverage_backfill_temp1 WHERE [retention] IS NOT NULL
	UNION ALL
	SELECT PolicyNumber, EffectiveDate, IssuedDate, policychangenumber, ObjectUniqueId, CONCAT(FinalColumnName, '_reason') AS FinalColumnName, reason           as FinalValue FROM edw_temp.tauto_vehicle_coverage_backfill_temp1 WHERE reason IS NOT NULL
) AS temp2
...
INTO [edw_temp].[tauto_vehicle_coverage_backfill_temp3]
FROM [edw_temp].[tauto_vehicle_coverage_backfill_temp2]
PIVOT 
(
...
LEFT JOIN edw_temp.tauto_vehicle_coverage_backfill_temp3 b
...
SELECT COUNT(1) FROM edw_core.tauto_vehicle_coverage t--172873
...
/*
UPDATE edw_core.tauto_vehicle_coverage
SET  uninsured_motorist_premium_adjustment_method = NULL
	,uninsured_motorist_premium_adjustment_amount = NULL
	,uninsured_motorist_premium_adjustment_retention = NULL
	,uninsured_motorist_premium_adjustment_reason = NULL
	,added_first_party_premium_adjustment_amount = NULL
	,added_first_party_premium_adjustment_method = NULL
	,added_first_party_premium_adjustment_reason = NULL
	,added_first_party_premium_adjustment_retention = NULL
	,added_personal_injury_protection_premium_adjustment_amount = NULL
	,added_personal_injury_protection_premium_adjustment_method = NULL
	,added_personal_injury_protection_premium_adjustment_reason = NULL
	,added_personal_injury_protection_premium_adjustment_retention = NULL
	,basic_first_party_premium_adjustment_amount = NULL
	,basic_first_party_premium_adjustment_method = NULL
	,basic_first_party_premium_adjustment_reason = NULL
	,basic_first_party_premium_adjustment_retention = NULL
	,customized_premium_adjustment_amount = NULL
	,customized_premium_adjustment_method = NULL
	,customized_premium_adjustment_reason = NULL
	,customized_premium_adjustment_retention = NULL
	,fire_premium_adjustment_amount = NULL
	,fire_premium_adjustment_method = NULL
	,fire_premium_adjustment_reason = NULL
	,fire_premium_adjustment_retention = NULL
	,property_protection_insurance_premium_adjustment_amount = NULL
	,property_protection_insurance_premium_adjustment_method = NULL
	,property_protection_insurance_premium_adjustment_reason = NULL
	,property_protection_insurance_premium_adjustment_retention = NULL
	,theft_premium_adjustment_amount = NULL
	,theft_premium_adjustment_method = NULL
	,theft_premium_adjustment_reason = NULL
	,theft_premium_adjustment_retention = NULL
	,uninsured_bodily_injury_premium_adjustment_amount = NULL
	,uninsured_bodily_injury_premium_adjustment_method = NULL
	,uninsured_bodily_injury_premium_adjustment_reason = NULL
	,uninsured_bodily_injury_premium_adjustment_retention = NULL
	,underinsured_motorist_premium_adjustment_amount = NULL
	,underinsured_motorist_premium_adjustment_method = NULL
	,underinsured_motorist_premium_adjustment_reason = NULL
	,underinsured_motorist_premium_adjustment_retention = NULL
	,uninsured_property_damage_premium_adjustment_amount = NULL
	,uninsured_property_damage_premium_adjustment_method = NULL
	,uninsured_property_damage_premium_adjustment_reason = NULL
	,uninsured_property_damage_premium_adjustment_retention = NULL
;
-- */