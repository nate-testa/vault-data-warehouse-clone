...
) BEGIN ALTER TABLE edw_core.tauto_vehicle_coverage ADD uninsured_motorist_premium_adjustment_amount Varchar(255) END
;
...
) BEGIN ALTER TABLE edw_core.tauto_vehicle_coverage ADD uninsured_motorist_premium_adjustment_method Varchar(255) END
;
...
) BEGIN ALTER TABLE edw_core.tauto_vehicle_coverage ADD uninsured_motorist_premium_adjustment_reason Varchar(255) END
;
...
) BEGIN ALTER TABLE edw_core.tauto_vehicle_coverage ADD uninsured_motorist_premium_adjustment_retention Varchar(255) END
;
