...
CONSTRAINT fk_tquote_grpel_master_coverage_enrollment_qt_cov_sk FOREIGN KEY (quote_grpel_master_coverage_sk) REFERENCES  edw_core.tquote_grpel_master_coverage(quote_grpel_master_coverage_sk)
