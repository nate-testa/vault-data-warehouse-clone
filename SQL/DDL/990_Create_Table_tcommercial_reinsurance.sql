IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES 
               ...
               AND TABLE_NAME = 'tcommercial_reinsurance')
BEGIN
CREATE TABLE edw_commercial.tcommercial_reinsurance
(
             
commercial_reinsurance_sk                       int IDENTITY(1,1) NOT NULL,
...
CONSTRAINT pk_tcommercial_reinsurance PRIMARY KEY (commercial_reinsurance_sk),
CONSTRAINT uidx_tcommercial_reinsurance_polno_effdt_commercial_reinsurance_sk UNIQUE (policy_no ,effective_dt,transaction_effective_dt,commercial_reinsurance_sk ),
CONSTRAINT fk_tcommercial_policy FOREIGN KEY (commercial_policy_sk) REFERENCES edw_commercial.tcommercial_policy (commercial_policy_sk)
...
(SELECT 1 FROM edw_core.tedw_table_detail
	where table_nm = 'tcommercial_reinsurance')
BEGIN
