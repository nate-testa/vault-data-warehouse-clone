...
BEGIN
CREATE TABLE edw_core.tgrpel_coverage
(
...
update_ts                           datetime,
etl_audit_sk                        int,
CONSTRAINT pk_tgrpel_coverage PRIMARY KEY (group_umbrella_coverage_sk),
CONSTRAINT uidx_tgrpel_coverage_polno_effdt_transeq UNIQUE (policy_no,effective_dt,transaction_seq_no),
CONSTRAINT fk_tgrpel_coverage_policy_history_sk FOREIGN KEY (policy_history_sk) REFERENCES  edw_core.tpolicy_history(policy_history_sk)
)
END;
