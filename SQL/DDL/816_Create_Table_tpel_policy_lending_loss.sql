CREATE TABLE edw_core.tpel_policy_lending_loss
(
pel_lending_loss_sk    int IDENTITY(1,1) NOT NULL,
...
update_ts                  datetime,
etl_audit_sk               int,
PRIMARY KEY (pel_lending_loss_sk),
CONSTRAINT fk_tpel_policy_lending_loss_policy_history_sk FOREIGN KEY (policy_history_sk) REFERENCES  edw_core.tpolicy_history(policy_history_sk)
);
