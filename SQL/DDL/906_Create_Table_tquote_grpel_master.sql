...
and TABLE_name = 'tquote_grpel_master')
BEGIN
CREATE TABLE edw_core.tquote_grpel_master
(
grpel_master_quote_sk                                                   int NOT NULL IDENTITY(1,1),  
...
employment_practices_liability_limit_250_250_25_premium_override_amt      varchar(255),   
employment_practices_liability_limit_250_250_25_premium_amt               varchar(255), 
employment_practices_liability_limit_500_500_50_premium_override_amt      varchar(255),
employment_practices_liability_limit_500_500_50_premium_amt               varchar(255),
family_trust_management_liability_limit_1m_premium_override_amt           varchar(255),
family_trust_management_liability_limit_1m_premium_amt                    varchar(255), 
non_profit_do_liability_limit_5m_premium_override_amt                     varchar(255), 
non_profit_do_liability_limit_5m_premium_amt                              varchar(255),
non_profit_do_liability_limit_4m_premium_override_amt                     varchar(255),  
non_profit_do_liability_limit_4m_premium_amt                              varchar(255),
non_profit_do_liability_limit_3m_premium_override_amt                     varchar(255),  
non_profit_do_liability_limit_3m_premium_amt                              varchar(255),
non_profit_do_liability_limit_2m_premium_override_amt                     varchar(255),
non_profit_do_liability_limit_2m_premium_amt                              varchar(255),   
non_profit_do_liability_limit_1m_premium_override_amt                     varchar(255),
...
CONSTRAINT uidx_tquote_grpel_master_grpel_quote_no_effective_dt UNIQUE (grpel_quote_no ,effective_dt)
)
END;
...
(SELECT 1 FROM edw_core.tedw_table_detail
	where table_nm = 'tquote_grpel_master')
BEGIN
