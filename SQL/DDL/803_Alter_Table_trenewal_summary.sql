...
AND COLUMN_NAME = 'prior_issued_ct'					
) BEGIN ALTER TABLE edw_core.trenewal_summary ADD prior_issued_ct int END ; 
...
WHERE TABLE_SCHEMA='edw_core'					
AND TABLE_NAME = 'trenewal_summary'					
AND COLUMN_NAME = 'in_progress_renewal_ct'					
) BEGIN ALTER TABLE edw_core.trenewal_summary ADD in_progress_renewal_ct int END ; 
...
WHERE TABLE_SCHEMA='edw_core'					
AND TABLE_NAME = 'trenewal_summary'					
AND COLUMN_NAME = 'closed_with_no_offer_renewal_ct'					
) BEGIN ALTER TABLE edw_core.trenewal_summary ADD closed_with_no_offer_renewal_ct int END ; 
