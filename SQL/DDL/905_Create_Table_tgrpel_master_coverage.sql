...
BEGIN
CREATE TABLE edw_core.tgrpel_master_coverage
(
grpel_master_coverage_sk                                                   int NOT NULL IDENTITY(1,1),  
...
CONSTRAINT pk_tgrpel_master_coverage PRIMARY KEY (grpel_master_coverage_sk),
CONSTRAINT uidx_tgrpel_master_coverage_grpel_policy_no_effective_dt_trans_seq_no UNIQUE (grpel_master_policy_no,effective_dt,transaction_seq_no)
)
END;
...
(SELECT 1 FROM edw_core.tedw_table_detail
	where table_nm = 'tgrpel_master_coverage')
BEGIN
