DECLARE @MainControlMetadata NVARCHAR(max)  = N'[
    {
        "SourceObjectSettings": {
            "schema": "dbo",
            "table": "GroupInsuranceEnrollmentParticipant"
        },
        "SinkObjectSettings": {
            "schema": "edw_stage",
            "table": "GroupInsuranceEnrollmentParticipant"
        ...
        "CopySourceSettings": {
            ...
            "sqlReaderQuery": "select * from [dbo].[GroupInsuranceEnrollmentParticipant]",
        ...
        "CopySinkSettings": {
            "preCopyScript": "TRUNCATE TABLE edw_stage.GroupInsuranceEnrollmentParticipant",
        ...
        "CopyEnabled": 1
			...
			(
  				...
  				WHERE JSON_value(SourceObjectSettings,'$.table') = 'GroupInsuranceEnrollmentParticipant'
			)