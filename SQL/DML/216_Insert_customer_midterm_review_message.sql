...
select '020' as message_id,'A backup generator can help protect your seasonal property from damage due to power loss, especially if no one is on site at the time. Enjoy increased peace of mind and protection credits when you install a backup generator. ' as message_desc, getdate(), getdate() union
