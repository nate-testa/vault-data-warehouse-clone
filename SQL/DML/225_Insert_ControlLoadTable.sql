DECLARE @MainControlMetadata NVARCHAR(max)  = N'[
    {
        ...
        "CopySourceSettings": {
            ...
            "sqlReaderQuery": "select * from [dbo].[SystemMarketingCode]",
        ...
        "CopySinkSettings": {
            "preCopyScript": "TRUNCATE TABLE edw_stage.SystemMarketingCode",
        ...
        "CopyActivitySettings": {
            "translator": {
                ...
                "mappings": [
                    ...
                    {
                        "source": {
                            "name": "AppliedToExistingInsureds",
                            "type": "Boolean",
                            "physicalType": "bit"
                        },
                        "sink": {
        ...
        "CopyEnabled": 1
			...
			(
  				...
  				WHERE JSON_value(SourceObjectSettings,'$.table') = 'SystemMarketingCode'
			)