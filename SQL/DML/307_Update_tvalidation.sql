...
WHERE d.actual_dt = ''var_actual_dt'' and dip.source_system_sk <> 6'
...
update edw_core.tvalidation_sql
set source_sql = 'select @source_ct=  count(*)  from
(  
