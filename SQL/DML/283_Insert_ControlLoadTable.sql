DECLARE @MainControlMetadata NVARCHAR(max)  = N'[
    {
        "SourceObjectSettings": {
            "schema": "dbo",
            "table": "AccountEnrollmentSnapshot"
        },
        "SinkObjectSettings": {
            "schema": "edw_stage",
            "table": "AccountEnrollmentSnapshot"
        ...
        "CopySourceSettings": {
            ...
            "sqlReaderQuery": "select * from [dbo].[AccountEnrollmentSnapshot]",
        ...
        "CopySinkSettings": {
            "preCopyScript": "TRUNCATE TABLE edw_stage.AccountEnrollmentSnapshot",
        ...
        "CopyActivitySettings": {
            "translator": {
                ...
                "mappings": [
                    ...
                    {
                        "source": {
                            "name": "EnrollmentInitialStartDate",
                            "type": "DateTime",
        ...
        "CopyEnabled": 1
			...
			(
  				...
  				WHERE JSON_value(SourceObjectSettings,'$.table') = 'AccountEnrollmentSnapshot'
			)