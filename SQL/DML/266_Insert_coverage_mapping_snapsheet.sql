...
union
select 'Group Personal Excess Liability' as product_nm,	'tgrpel_coverage' as table_nm,'group_excess_liability_limit_amt' as column_nm,'Excess liability' as snapsheet_coverage_nm,'EXL' as snapsheet_coverage_nm,'Limit' as coverage_type,	NULL as snapsheet_deductible_type,getdate() as create_ts,getdate() as update_ts
union
