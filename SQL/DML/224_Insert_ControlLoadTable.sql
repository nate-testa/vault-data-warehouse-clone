DECLARE @MainControlMetadata NVARCHAR(max)  = N'[
    {
        "SourceObjectSettings": {
            "schema": "dbo",
            "table": "InsuredMarketingPreference"
        },
        "SinkObjectSettings": {
            "schema": "edw_stage",
            "table": "InsuredMarketingPreference"
        ...
        "CopySourceSettings": {
            ...
            "sqlReaderQuery": "select * from [dbo].[InsuredMarketingPreference]",
        ...
        "CopySinkSettings": {
            "preCopyScript": "TRUNCATE TABLE edw_stage.InsuredMarketingPreference",
