...
set CopyActivitySettings = '{
	"translator": {
		...
		"mappings": [
			...
			{
				"source": {
					"name": "InProgressStartedByExternally",
					"type": "Boolean",
					"physicalType": "bit"
				},
				"sink": {
			...
			{
				"source": {
					"name": "RenewalChangeNoteUpdatedById",
					"type": "Guid",
					"physicalType": "uniqueidentifier"
				},
				"sink": {
			...
			{
				"source": {
					"name": "RenewalChangeNoteUpdatedDate",
					"type": "DateTime",
					"physicalType": "datetime2"
				},
				"sink": {
			...
			{
				"source": {
					"name": "CurrentOrBoundTotalPremiumForExternal",
					"type": "Decimal",
					"physicalType": "decimal"
				},
				"sink": {
			...
			{
				"source": {
					"name": "RenewalRulesApplyRequired",
					"type": "Boolean",
					"physicalType": "bit"
				},
				"sink": {
