...
where c.claim_sk = cf.claim_sk 
and cf.source_system_sk = 5  
and c.policy_no not in (''AU9999VES'', ''AU9999VRE'', ''COV9999VES'', ''COV9999VRE'', ''FPP9999VES'', ''FPP9999VRE'') 
and cf.product_sk != 4 
and cf.item_sk is null',
target_sql = 'select 2'
...
and cf.source_system_sk = 5  
and c.policy_no not in (''AU9999VES'', ''AU9999VRE'', ''COV9999VES'', ''COV9999VRE'', ''FPP9999VES'', ''FPP9999VRE'') 
and c.policy_no not like ''NFP%''
and cf.coverage_sk is null',
target_sql = 'select 1'
...
where c.claim_sk = cf.claim_sk 
and cf.source_system_sk = 5  
and c.policy_no not in (''AU9999VES'', ''AU9999VRE'') 
and cf.product_sk = 3 
and cf.vehicle_coverage_sk is null',
target_sql = 'select 1'
