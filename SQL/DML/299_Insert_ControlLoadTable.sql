DECLARE @MainControlMetadata NVARCHAR(max)  = N'[
    {
        ...
        "CopySourceSettings": {
            ...
            "sqlReaderQuery": "select * from [dbo].[GroupInsurance]",
        ...
        "CopySinkSettings": {
            "preCopyScript": "TRUNCATE TABLE edw_stage.GroupInsurance",
        ...
        "CopyActivitySettings": {
            "translator": {
                ...
                "mappings": [
                    ...
                    {
                        "source": {
                            "name": "EnrollmentValidationFileBlobContainer",
                            "type": "String",
                            "physicalType": "nvarchar"
                        },
                        "sink": {
                    ...
                    {
                        "source": {
                            "name": "EnrollmentValidationFileBlobIdentifier",
                            "type": "String",
                            "physicalType": "nvarchar"
                        },
                        "sink": {
        ...
        "CopyEnabled": 1
			...
			(
  				...
  				WHERE JSON_value(SourceObjectSettings,'$.table') = 'GroupInsurance'
			)