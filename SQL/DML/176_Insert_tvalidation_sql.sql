...
SELECT
	'Metal validation - Clearinghouse fee transactions mapped to incorrect coverage category ' AS validation_sql_desc ,
...
UNION
SELECT
	'Metal validation - EMPA Surcharge transactions mapped to incorrect coverage category' AS validation_sql_desc ,
...
UNION
SELECT
	'Metal validation - Surplus Lines Tax transactions mapped to incorrect coverage category ' AS validation_sql_desc ,
...
UNION
SELECT
	'Metal validation - Healthy Homes Fund Surcharge transactions mapped to incorrect coverage category ' AS validation_sql_desc ,
