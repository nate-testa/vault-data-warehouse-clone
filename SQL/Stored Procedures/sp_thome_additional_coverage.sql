...
-- 06/02/25						Yunus Mohammed				   18. AD-9691 Modified seperator for gate_code 
-- 06/02/25						Sandeep Gundreddy			   19. Modified gate location and code seperator from ',' to '-'
-- 07/02/25						Dinesh Bobbili				   20. AD-10034 Added all_peril_roof_covering_coverage_specified_states_in column
-- ===========================================================================================================================
...
BEGIN
	...
	BEGIN TRY
		...
		from
			...
			all_peril_roof_covering_coverage_cw_in,gate_entry_code_required_in,all_peril_roof_covering_coverage_specified_states_in,
