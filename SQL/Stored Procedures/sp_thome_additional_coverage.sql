...
BEGIN
	...
	BEGIN TRY
		...
		'+ @ColumnsToPivot +' into edw_temp.thome_additional_coverage_temp1
			...
			,agreed_value_in
			,backup_of_sewers_limit_in,contents_extended_replacement_cost_in,contents_extended_replacement_cost_limit
          ...
          ,LandscapingCoverageIncreasedPlantLimit AS landscaping_coverage_increased_plant_limit_amt
		   ...
		   ,ContentsExtendedReplacementCostLimit AS contents_extended_replacement_cost_limit
