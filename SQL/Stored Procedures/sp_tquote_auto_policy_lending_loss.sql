...
--
-- ================================================================================================================================================
CREATE OR ALTER PROCEDURE [edw_core].[sp_tquote_auto_policy_lending_loss] 
AS
BEGIN
	...
	BEGIN TRY
		...
		DROP TABLE IF EXISTS [edw_temp].[tquote_auto_policy_lending_loss_temp1];
        ...
        INTO [edw_temp].[tquote_auto_policy_lending_loss_temp1]
        FROM (
            SELECT  
            acct.CreatedDate, acct.PolicyNumber as quote_no, acct.EffectiveDate as effective_dt, acct.TransactionEffectiveDate as transaction_effective_dt, 
                    ...
                    WHERE
                        ...
                        --and acct.PolicyNumber = 'AU200027998'
                        ) t
                PIVOT 
                (
		...
		INSERT INTO [edw_core].[tquote_auto_policy_lending_loss]
        (
            quote_no
            ,effective_dt
            ,expiration_dt
        ...
        FROM 
            [edw_temp].[tquote_auto_policy_lending_loss_temp1] AS t1
        ;
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(CreatedDate) FROM edw_temp.[tquote_auto_policy_lending_loss_temp1]),@last_source_extract_ts);
