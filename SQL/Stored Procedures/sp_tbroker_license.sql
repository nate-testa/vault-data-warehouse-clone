...
BEGIN
	...
	BEGIN TRY
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(GREATEST(br.CreatedDate,br.UpdatedDate)) FROM edw_temp.tbroker_license_temp br),@last_source_extract_ts)
