...
-- =================================================================================================
-- Description: This procedures inserts data into tbroker_servicing_team_member
---------------------------------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		DROP TABLE IF EXISTS edw_temp.tbroker_servicing_team_member_temp

		SELECT 
				a.broker_servicing_team_sk,
				NULLIF(TRIM(u.name),'') full_nm, 
		...
		DBCC CHECKIDENT('edw_core.tbroker_servicing_team_member',RESEED,0);
