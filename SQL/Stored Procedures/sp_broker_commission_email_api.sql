...
BEGIN
	...
	BEGIN TRY
        ...
        SELECT
            distinct b.broker_id AS broker_id,
            COALESCE(b.dba_nm, b.broker_nm) AS broker_nm,
            b.primary_address_city_nm AS broker_city_nm,
            b.primary_address_state_cd AS broker_state_cd,
