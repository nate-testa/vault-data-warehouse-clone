...
-- 04/27/26				Yunus Mohammed			2. AD-13187 Code updated for recoding payments
-- ======================================================================================================== 
...
BEGIN
	...
	FROM edw_stage_snapsheet.financial_reserve_items res
			...
			LEFT JOIN edw_commercial.tcommercial_claim_feature tf ON tf.claim_no = tc.claim_no and e.id = tf.claim_coverage_cd
			LEFT JOIN edw_commercial.tcommercial_policy tp ON tp.commercial_policy_sk = tc.commercial_policy_sk
	...
	INSERT INTO edw_commercial.tcommercial_claim_transaction
	(
		commercial_claim_sk,
		commercial_claim_feature_sk,
		product_sk,
