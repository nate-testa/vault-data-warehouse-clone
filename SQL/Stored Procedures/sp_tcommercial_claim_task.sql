...
BEGIN
	...
	BEGIN TRY
		...
		DROP TABLE IF exists edw_temp.tcommercial_claim_task_temp1;
		...
		SET
			...
			SET @new_last_source_extract_ts=COALESCE((SELECT MAX(GREATEST(task_created_ts,task_updated_ts)) FROM edw_temp.tcommercial_claim_task_temp1),@last_source_extract_ts)
