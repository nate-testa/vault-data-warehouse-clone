...
BEGIN
	...
	BEGIN TRY
        ...
        SELECT 
            ...
            RIGHT('00000' + REPLACE(REPLACE(REPLACE(ISNULL([VehicleOperatorAddrZipCode],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 5) AS [VehicleOperatorAddrZipCode],
	        RIGHT('0000' + REPLACE(REPLACE(REPLACE(ISNULL([VehicleOperatorAddrZipPlus4],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 4) AS [VehicleOperatorAddrZipPlus4],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([Filler_reservedForFutureUse4],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [Filler_reservedForFutureUse4],
            RIGHT('000000000' + REPLACE(REPLACE(REPLACE(ISNULL([VehicleOperatorSSN],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 9) AS [VehicleOperatorSSN],
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([VehicleOperatorDOB],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 8) AS [VehicleOperatorDOB],
            ...
            REPLACE(REPLACE(REPLACE(ISNULL([claimAmount],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ') AS [claimAmount],
            ...
            RIGHT('0000' + REPLACE(REPLACE(REPLACE(ISNULL([InsuredVehicleModelYear],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 4) AS [InsuredVehicleModelYear],
            ...
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([DateofFirstPayment],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 8) AS [DateofFirstPayment],
