	...
	BEGIN TRY
		...
		USING (
		    SELECT
				...
				LicenseNumber AS license_no,driver_unique_id,
		        source_system_sk AS source_system_sk,
		        GETDATE() AS create_ts,
		        GETDATE() AS update_ts,
		        @etl_audit_sk AS etl_audit_sk
		    FROM
		        edw_temp.tquote_grpel_driver_wip_temp1
		) AS source
		ON
		...
		WHEN MATCHED THEN
            ...
            SET               
                ...
                target.relationship_to_insured=source.relationship_to_insured,
                target.dui_dwi_in=source.dui_dwi_in,
		...
		WHEN NOT MATCHED BY TARGET THEN
		    ...
		    VALUES (
                ...
                source.driver_no,first_nm ,source.middle_nm,source.last_nm ,source.birth_dt ,source.relationship_to_insured,source.dui_dwi_in,
