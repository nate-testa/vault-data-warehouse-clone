...
BEGIN
	...
	BEGIN TRY
		...
		'+ @ColumnsToPivot +' into edw_temp.tquote_home_coverage_wip_temp1
			...
			[target].[100_pc_dwelling_limit_value_amt] = [source].[100_pc_dwelling_limit_value_amt],
			[target].[100_pc_other_structures_limit_value_amt] = [source].[100_pc_other_structures_limit_value_amt],
			[target].[100_pc_contents_limit_value_amt] = [source].[100_pc_contents_limit_value_amt],
			[target].[100_pc_loss_of_use_value_amt] = [source].[100_pc_loss_of_use_value_amt],
