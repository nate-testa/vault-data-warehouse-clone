...
-- ================================================================================================= 
CREATE OR ALTER PROCEDURE [edw_core].[sp_commercial_claim_workday_reserve_feed]
...
BEGIN
    ...
    SET @ProcedureName = OBJECT_NAME(@@PROCID)
		...
		BEGIN
            ...
            WITH commercial_claim_reserve_feed_temp AS
            (
                SELECT
                DISTINCT
			...
			FROM
				commercial_claim_reserve_feed_temp
			WHERE
				reserve_amount != 0
