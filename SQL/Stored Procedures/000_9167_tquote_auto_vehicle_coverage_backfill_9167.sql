...
--1) Drop table
DROP TABLE IF EXISTS edw_temp.tquote_auto_vehicle_coverage_backfill_temp1;
DROP TABLE IF EXISTS edw_temp.tquote_auto_vehicle_coverage_backfill_temp2;
DROP TABLE IF EXISTS edw_temp.tquote_auto_vehicle_coverage_backfill_temp3;
...
INTO edw_temp.tquote_auto_vehicle_coverage_backfill_temp1
...
SELECT * 
INTO edw_temp.tquote_auto_vehicle_coverage_backfill_temp2
FROM (
	SELECT PolicyNumber, EffectiveDate, Number, ObjectUniqueId, CONCAT(FinalColumnName, '_method') AS FinalColumnName, method           as FinalValue FROM edw_temp.tquote_auto_vehicle_coverage_backfill_temp1 WHERE method IS NOT NULL
	UNION ALL
	SELECT PolicyNumber, EffectiveDate, Number, ObjectUniqueId, CONCAT(FinalColumnName, '_amount') AS FinalColumnName, amount           as FinalValue FROM edw_temp.tquote_auto_vehicle_coverage_backfill_temp1 WHERE amount IS NOT NULL
	UNION ALL
	SELECT PolicyNumber, EffectiveDate, Number, ObjectUniqueId, CONCAT(FinalColumnName, '_retention') AS FinalColumnName, [retention]   as FinalValue FROM edw_temp.tquote_auto_vehicle_coverage_backfill_temp1 WHERE [retention] IS NOT NULL
	UNION ALL
	SELECT PolicyNumber, EffectiveDate, Number, ObjectUniqueId, CONCAT(FinalColumnName, '_reason') AS FinalColumnName, reason           as FinalValue FROM edw_temp.tquote_auto_vehicle_coverage_backfill_temp1 WHERE reason IS NOT NULL
) AS temp2
...
INTO [edw_temp].[tquote_auto_vehicle_coverage_backfill_temp3]
FROM [edw_temp].[tquote_auto_vehicle_coverage_backfill_temp2]
PIVOT 
(
...
INNER JOIN edw_temp.tquote_auto_vehicle_coverage_backfill_temp3 b
...
SELECT count(1) FROM edw_core.tquote_auto_vehicle_coverage t--172873
...
/*
UPDATE edw_core.tquote_auto_vehicle_coverage
