...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			policy_no, effective_dt, transaction_seq_no, driver_no, VersionObjectId,  driver_unique_id,
        ...
        SELECT 
            ...
            , b.vehicle_list
            , t1.driver_unique_id
        into  [edw_temp].[tauto_driver_temp3]
        ...
        SELECT 
            ...
            t1.gender,
            t1.marital_status,
            t1.relationship_to_insured,
            t1.driver_status,
            t1.sr22_certification_required_in,
            t1.sr22_certification_state_cd,
            t1.defensive_driver_in,
            t1.training_discount_in,
            t1.license_status,
            t1.license_country_nm,
            t1.license_state_nm,
            t1.license_no,
            t1.license_year,
            t1.licensed_received_age,
            t1.no_of_years_licensed,
            t1.unverifiable_driving_record_in,
            t1.multiple_incident_factor,
            t1.defensive_course_completed_in,
            t1.defensive_course_completed_two_years_in,
            t1.defensive_course_completed_three_years_in,
            t1.defensive_course_completion_dt,
            t1.training_course_completed_in,
            t1.good_student_in,
            t1.away_at_school_in,
            t1.military_personnel_discount_in,
            t1.asarmy_national_guard_personnel_discount_in,
            t1.mobile_device_control_discount_in,
            t1.seasonal_use_part_in,
            t1.occasional_operator_discount,
            t1.reported_incidents_ct,
            t1.sdip_points_no,
            t1.aaf_with_vault_ct,
            t1.afb_with_vault_ct,
            t1.naf_with_vault_ct,
            t1.cpa_with_vault_ct,
            t1.min_with_vault_ct,
            t1.maj_with_vault_ct,
            t1.spd_with_vault_ct,
            t1.aaf_prior_ct,
            t1.afb_prior_ct,
            t1.naf_prior_ct,
            t1.cpa_prior_ct,
