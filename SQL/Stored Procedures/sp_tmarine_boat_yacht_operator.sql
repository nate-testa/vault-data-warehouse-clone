...
-- ===============================================================================================================================================
CREATE OR ALTER PROCEDURE [edw_core].[sp_tmarine_boat_yacht_operator]
AS
BEGIN
	...
	BEGIN TRY
		...
		DROP TABLE IF EXISTS edw_temp.tmarine_boat_yacht_operator_temp1;
		...
		SELECT 
			...
			source_system_sk,
			IssuedDate
		INTO edw_temp.tmarine_boat_yacht_operator_temp1
		FROM
			(
				SELECT
		...
		INSERT INTO [edw_core].[tmarine_boat_yacht_operator]
		(
			policy_no,
			effective_dt,
			transaction_effective_dt,
		...
		FROM edw_temp.tmarine_boat_yacht_operator_temp1;
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(IssuedDate) FROM edw_temp.tmarine_boat_yacht_operator_temp1),@last_source_extract_ts)	
