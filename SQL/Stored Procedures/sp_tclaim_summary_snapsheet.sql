...
-- ================================================================================================= 
CREATE OR ALTER PROCEDURE [edw_core].[sp_tclaim_summary_snapsheet]
AS
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			claim_closed_with_pay_ct=(CASE WHEN closed_claim_ct=1 AND (itd_total_paid_amt-itd_salvage_recovery_amt)>0 THEN 1 ELSE 0 END),
			claim_closed_without_pay_ct=(CASE WHEN closed_claim_ct=1 AND (itd_total_paid_amt-itd_salvage_recovery_amt)=0 THEN 1 ELSE 0 END)
