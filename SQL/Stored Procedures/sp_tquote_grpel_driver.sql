...
-- Description: This procedures insert Participant Personal Excess Liability driver data quotes
-- =============================================
---------------------------------------------------------------------------------------------------
...
-- ================================================================================================= 
CREATE OR ALTER PROCEDURE [edw_core].[sp_tquote_grpel_driver]
...
BEGIN
	...
	BEGIN TRY
		...
		FROM
			edw_temp.tquote_grpel_driver_temp1 AS ttlc

		SET @rows_affected=@@ROWCOUNT;

		-- Update control table
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(CreatedDate) FROM edw_temp.tquote_grpel_driver_temp1),@last_source_extract_ts);	
