	...
	BEGIN TRY
        ...
        USING (
            SELECT
                ...
                BankVaultedJewelryCoverage AS bank_vaulted_jewelry_coverage_in,
                CoinsCoverage AS coins_coverage_in,
                CollectiblesCoverage AS collectibles_coverage_in,
                FineArtsCoverage AS fine_arts_coverage_in,
                FursCoverage AS furs_coverage_in,
                GunsCoverage AS guns_coverage_in,
                JewelryCoverage AS jewelry_coverage_in,
                MiscellaneousCoverage AS miscellaneous_coverage_in,
                MusicalInstrumentsCoverage AS musical_instruments_coverage_in,
                SilverCoverage AS silver_coverage_in,
                StampsCoverage AS stamps_coverage_in,
                WearableCollectiblesCoverage AS wearable_collectibles_coverage_in,
                WineCoverage AS wine_coverage_in,
                ...
                EarthquakeDeductibleLossLimitations AS earthquake_deductible_loss_limitations_in,
                EarthquakeDeductibleLossLimitationsLimit AS earthquake_deductible_loss_limitations_limit,
                ...
                HurricaneDeductibleAmount AS hurricane_deductible_amt,
                ...
                WildfireNoOfOccurrencesNear AS wildfire_no_of_occurrences_near,
                WildfireNoOfOccurrences AS wildfire_no_of_occurrences,
                ...
                CoutureWearableCollectiblesClass AS couture_wearable_collectibles_class_in,
                source_system_sk,
