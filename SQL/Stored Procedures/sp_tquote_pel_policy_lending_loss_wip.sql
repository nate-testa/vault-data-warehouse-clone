...
--
-- ================================================================================================================================================
CREATE OR ALTER PROCEDURE [edw_core].[sp_tquote_pel_policy_lending_loss_wip]
AS
BEGIN
	...
	BEGIN TRY
		...
		DROP TABLE IF EXISTS [edw_temp].[tquote_pel_policy_lending_loss_wip_temp1];
        SELECT 
        ...
        INTO [edw_temp].[tquote_pel_policy_lending_loss_wip_temp1]
        FROM
			(
                SELECT
                ...
                WHERE p.[Name] = 'Personal Excess Liability'
		...
		-- Start Merge process
		MERGE INTO [edw_core].[tquote_pel_policy_lending_loss] AS target
        USING [edw_temp].[tquote_pel_policy_lending_loss_wip_temp1] AS source
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(Greatest(CreatedDate,UpdatedDate)) FROM edw_temp.[tquote_pel_policy_lending_loss_wip_temp1]),@last_source_extract_ts);
