...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			...
			np.employment_practises_liability_coverage AS employment_practises_liability_limit_amt,
			np.employment_practises_liability_premium AS employment_practises_liability_premium_amt,
			np.[non_profit_d&o_liability_coverage] AS non_profit_do_liability_limit_amt,
			...
			np.underlying_auto_liability_limit AS underlying_auto_liability_limit_amt,
			...
			np.underinsured_liability_limit AS underinsured_liability_limit_desc,
