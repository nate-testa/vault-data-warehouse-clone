...
-- Description: This procedure reconciles commercial policy data 
---------------------------------------------------------------------------------------------------------------------------------------
-- Change date |Author						             |	Change Description
---------------------------------------------------------------------------------------------------------------------------------------
-- 12/02/25		Yunus Mohammed				1. Created this procedure
-- ===============================================================================================================================================

CREATE OR ALTER PROCEDURE [edw_core].[sp_tcommercial_reconciliation]
	...
	(		
		...
		(
			select acctr.PolicyNumber policy_no, acctr.PolicyChangeNumber transaction_seq_no,
						cast(acctr.BindDate as date) iss_dt,  
			...
			where acctr.PolicyNumber is not null 
				...
				AND cast(acctr.BindDate as date) between @last_source_extract_ts and @max_transaction_ts
