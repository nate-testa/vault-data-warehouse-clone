...
BEGIN
    ...
    SET NOCOUNT ON
		...
		END
		-- Create temp table
		DROP TABLE IF EXISTS edw_temp.tcommercial_reconciliation_snapsheet_temp1
		...
		-- Insert and Update tcommercial_reconciliation table
		MERGE [edw_commercial].[tcommercial_reconciliation] AS Target
		USING edw_temp.tcommercial_reconciliation_snapsheet_temp1 AS Source
