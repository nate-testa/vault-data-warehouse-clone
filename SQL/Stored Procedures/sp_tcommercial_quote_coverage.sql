...
BEGIN	
	...
	BEGIN TRY
		...
		IssuedDate,commercial_quote_history_sk,product_name	,
		...
		into edw_temp.tcommercial_quote_coverage_temp1
			...
			cph.commercial_quote_history_sk,
        ...
        (
            quote_no,effective_dt,expiration_dt,transaction_effective_dt,transaction_dt,transaction_seq_no,
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(IssuedDate) FROM edw_temp.tcommercial_quote_coverage_temp1),@last_source_extract_ts)
