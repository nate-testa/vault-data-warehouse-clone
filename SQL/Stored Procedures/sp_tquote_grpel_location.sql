...
-- Description: This procedures insert Participant Personal Excess Liability location  for quotes
-- =============================================
---------------------------------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(CreatedDate) FROM edw_temp.tquote_grpel_location_temp1),@last_source_extract_ts)	
