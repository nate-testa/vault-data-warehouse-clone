-- ========================================================================================================
-- Description: This procedures updates commercial claim financials
-----------------------------------------------------------------------------------------------------------
-- Change date              |Author									|	Change Description
-----------------------------------------------------------------------------------------------------------
-- 11/19/2025		        Yunus Mohammed			1. Created this procedure
-- ======================================================================================================== 
CREATE OR ALTER PROCEDURE [edw_core].[sp_update_tcommercial_claim]
AS
BEGIN
	...
	BEGIN TRY
		...
		FROM edw_commercial.tcommercial_claim cl
		INNER JOIN (
			SELECT
				clt.commercial_claim_sk,
			...
			FROM edw_commercial.tcommercial_claim cl
			INNER JOIN edw_commercial.tcommercial_claim_transaction clt ON cl.commercial_claim_sk=clt.commercial_claim_sk
			GROUP BY clt.commercial_claim_sk
		) src ON cl.commercial_claim_sk = src.commercial_claim_sk

		SET @rows_affected=@@ROWCOUNT
		

		UPDATE edw_commercial.tcommercial_claim
		SET 
