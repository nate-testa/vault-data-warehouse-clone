...
BEGIN
	...
	BEGIN TRY
		...
		select 
			...
			,location_deleted_in,OwnedByTrustLLCOrOtherEntity ,TrustOrLegalEntityLegalName ,MailingAddressTrustOrLegalEntity ,TrustOrLegalEntityPurpose ,
		...
		(
			...
			,location_deleted_in,owned_by_trust_llc_or_other_entity_in ,trust_or_legal_entity_legal_nm ,mailing_address_trust_or_legal_entity ,
