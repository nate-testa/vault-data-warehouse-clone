...
-- Description: This procedures inserts workday claim litigation reserve data
---------------------------------------------------------------------------------------------------
-- Change date						|Author									|	Change Description
---------------------------------------------------------------------------------------------------
-- 04/23/25							Yunus Mohammed				1. Created this procedure 
-- ================================================================================================= 
CREATE OR ALTER PROCEDURE [edw_core].[sp_claim_litigation_workday_reserve_feed]
...
BEGIN
    ...
    SET @ProcedureName = OBJECT_NAME(@@PROCID)
		...
		BEGIN
			...
			INSERT INTO edw_integration.claim_litigation_workday_reserve_feed
			(
			...
			FROM
				claim_litigation_reserve_feed_temp
			WHERE
				reserve_amount != 0
