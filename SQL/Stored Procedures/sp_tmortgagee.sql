...
-- =============================================
CREATE OR ALTER PROCEDURE [edw_core].[sp_tmortgagee]
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO [edw_core].[tmortgagee]
		(
		...
		FROM
			edw_temp.tmortgagee_temp1 AS ttlc

		SET @rows_affected=@@ROWCOUNT;

		-- Update control table
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(IssuedDate) FROM edw_temp.tmortgagee_temp1),@last_source_extract_ts);	
