-- ========================================================================================================
-- Description: This procedures updates commercial claim feature financials
-----------------------------------------------------------------------------------------------------------
-- Change date 		    |Author						                |	Change Description
-----------------------------------------------------------------------------------------------------------
-- 11/19/2025		  Yunus Mohammed				1. Created this procedure
-- ======================================================================================================== 
CREATE OR ALTER PROCEDURE [edw_core].[sp_update_tcommercial_claim_feature]
AS
BEGIN   
	...
	BEGIN TRY
		...
		FROM edw_commercial.tcommercial_claim_feature clf
		INNER JOIN (
			SELECT
				clt.commercial_claim_feature_sk,
			...
			FROM edw_commercial.tcommercial_claim_feature clf
			INNER JOIN edw_commercial.tcommercial_claim_transaction clt ON clf.commercial_claim_feature_sk=clt.commercial_claim_feature_sk
			GROUP BY clt.commercial_claim_feature_sk
		) src ON clf.commercial_claim_feature_sk = src.commercial_claim_feature_sk
		;

		SET @rows_affected=@@ROWCOUNT;

		UPDATE edw_commercial.tcommercial_claim_feature
		SET 
