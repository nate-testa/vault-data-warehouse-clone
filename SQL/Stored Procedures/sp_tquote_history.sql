...
BEGIN
	...
	BEGIN TRY
		...
		--LEFT JOIN edw_core.tquote_transaction_type tt on tt.policy_transaction_type_cd = source.stage
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(t1.CreatedDate) FROM edw_temp.tquote_history_temp1 t1),@last_source_extract_ts);
