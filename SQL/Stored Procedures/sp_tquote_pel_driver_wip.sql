	...
	BEGIN TRY
		...
		WHEN NOT MATCHED BY TARGET THEN
		    ...
		    VALUES (
		        ...
		        SOURCE.license_no, SOURCE.source_system_sk, SOURCE.create_ts, SOURCE.update_ts, SOURCE.etl_audit_sk, SOURCE.driver_limit_type
		);

		SET @rows_affected=@@ROWCOUNT;

		-- Update control table
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(greatest(t1.CreatedDate, t1.UpdatedDate)) FROM edw_temp.tquote_pel_driver_wip_temp1),@last_source_extract_ts);	
