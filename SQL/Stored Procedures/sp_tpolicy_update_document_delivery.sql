...
BEGIN
	...
	BEGIN TRY
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(greatest(CreatedDate,UpdatedDate)) FROM edw_temp.tpolicy_update_document_delivery_temp1 t1),@last_source_extract_ts);
