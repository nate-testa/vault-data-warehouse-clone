...
---------------------------------------------------------------------------------------------------
-- 11/21/24		    Hernando Gonzalez			1. Created this procedure 
-- ================================================================================================= 
CREATE OR ALTER PROCEDURE [edw_core].[sp_tmarine_boat_yacht_coverage]
...
BEGIN
	...
	BEGIN TRY
		...
		DROP TABLE IF EXISTS edw_temp.tmarine_boat_yacht_coverage_temp3
		SELECT 
			...
			,policy_history_sk
			--
			,[marine_boat_yacht_sk]
			,[marine_boat_yacht_location_sk]
			--
			--
			...
			--
		INTO edw_temp.tmarine_boat_yacht_coverage_temp3
		FROM
		(
			SELECT * 
			FROM
			(
				...
				,mbyl.[marine_boat_yacht_location_sk] --
		...
		-- Drop temp table
		DROP TABLE IF EXISTS edw_temp.tmarine_boat_yacht_coverage_temp1
	END TRY
	BEGIN CATCH
