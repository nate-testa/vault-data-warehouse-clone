...
BEGIN
	...
	BEGIN TRY
		...
		select 
			...
			CreatedDate,MooringLocationAddressLine1 as address_line_1,
            ...
            MooringLocationAddressState as state_cd,MooringLocationAddressZipCode as zip_cd,
			MooringLocationAddressCounty as county_nm,MooringLocationAddressCountry as country_nm
		...
		(
            ...
            (
                MooringLocationAddressLine1,MooringLocationAddressLine2,MooringLocationAddressLineUnit,MooringLocationAddressCity,MooringLocationAddressState,MooringLocationAddressZipCode,MooringLocationAddressCounty,MooringLocationAddressCountry
            )
		) as pivottable
