...
BEGIN
	...
	BEGIN TRY
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(greatest(t1.CreatedDate, t1.UpdatedDate)) FROM edw_temp.tquote_pel_coverage_wip_temp1),@last_source_extract_ts)
