...
--	01-22-2025				Yunus Mohammed				Errors removed
-- ================================================================================================= 
...
BEGIN
	...
	BEGIN TRY
		...
		set
			...
			(
				JSON_MODIFY([source].[data] collate SQL_Latin1_General_CP1_CI_AS, '$.data.attributes.payee.contact_methods[0].value', '7272901574'),
