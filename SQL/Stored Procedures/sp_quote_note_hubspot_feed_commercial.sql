-- ====================================================================================================================
-- Description: This procedures inserts and updates quote note hubspot commercial data
-----------------------------------------------------------------------------------------------------------------------
...
CREATE OR ALTER PROCEDURE [edw_core].[sp_quote_note_hubspot_feed_commercial]
...
BEGIN
    ...
    SET NOCOUNT ON
		...
		DROP TABLE IF exists edw_temp.quote_note_hubspot_feed_commercial_temp1;
        ...
        into edw_temp.quote_note_hubspot_feed_commercial_temp1
        from [edw_core].[tnote_commercial] n
        ...
        USING [edw_temp].[quote_note_hubspot_feed_commercial_temp1] AS source on target.note_id = source.note_id
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(Greatest(create_ts,update_ts)) FROM edw_temp.[quote_note_hubspot_feed_commercial_temp1]),@last_source_extract_ts);
