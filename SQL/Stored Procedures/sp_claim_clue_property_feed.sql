...
BEGIN
	...
	BEGIN TRY
        ...
        SELECT 
            ...
            RIGHT('000000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimAmount],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 9) AS [claimAmount],
            ...
            RIGHT('00000' + REPLACE(REPLACE(REPLACE(ISNULL([riskAddressZip],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 5) AS [riskAddressZip],
            RIGHT('0000' + REPLACE(REPLACE(REPLACE(ISNULL([riskAddressZipPlus4],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 4) AS [riskAddressZipPlus4],
            ...
            RIGHT('000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderTelAreaCode],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 3) AS [policyHolderTelAreaCode],
            RIGHT('0000000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderTelNumber],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 7) AS [policyHolderTelNumber],
            ...
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderDOB],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 8) AS [policyHolderDOB],
            ...
            RIGHT('000000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantSSN],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 9) AS [claimantSSN],
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantDOB],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 8) AS [claimantDOB],
            ...
            RIGHT('00000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressZip],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 5) AS [claimantAddressZip],
            RIGHT('0000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressZipPlus4],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 4) AS [claimantAddressZipPlus4],
            RIGHT('000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantTelephoneAreaCode],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 3) AS [claimantTelephoneAreaCode],
            RIGHT('0000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantTelephoneNumber],'0'), CHAR(9), '0'), CHAR(13), '0'), CHAR(10), '0'), 7) AS [claimantTelephoneNumber],
