...
BEGIN
	...
	BEGIN TRY
        ...
        SELECT 
            RIGHT('00000' + REPLACE(REPLACE(REPLACE(ISNULL([contribCompany],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 5) AS [contribCompany],
            ...
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimDate],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 8) AS [claimDate],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([causeOfLoss],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [causeOfLoss],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([locationOfLoss],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [locationOfLoss],
            RIGHT('000000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimAmount],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 9) AS [claimAmount],
            ...
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([catastropheRelated],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [catastropheRelated],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([mortgageName],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [mortgageName],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([mortgageLoanNumber],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [mortgageLoanNumber],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([filler_reservedforFutureUse],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [filler_reservedforFutureUse],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([riskAddressHseNum],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [riskAddressHseNum],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([riskAddressStreetName],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [riskAddressStreetName],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([riskAddressAptNum],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [riskAddressAptNum],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([riskAddressCity],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [riskAddressCity],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([riskAddressState],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [riskAddressState],
            RIGHT('00000' + REPLACE(REPLACE(REPLACE(ISNULL([riskAddressZip],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 5) AS [riskAddressZip],
            RIGHT('0000' + REPLACE(REPLACE(REPLACE(ISNULL([riskAddressZipPlus4],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 4) AS [riskAddressZipPlus4],
            ...
            RIGHT('00000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderMailAddressZip],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 5) AS [policyHolderMailAddressZip],
            RIGHT('0000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderMailAddressZipPlus4],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 4) AS [policyHolderMailAddressZipPlus4],
            RIGHT('000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderTelAreaCode],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 3) AS [policyHolderTelAreaCode],
            RIGHT('0000000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderTelNumber],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 7) AS [policyHolderTelNumber],
            ...
            RIGHT('000000000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderSSN],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 9) AS [policyHolderSSN],
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolderDOB],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 8) AS [policyHolderDOB],
            ...
            RIGHT('000000000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolder2SSN],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 9) AS [policyHolder2SSN],
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([policyHolder2DOB],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 8) AS [policyHolder2DOB],
            ...
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantNamePrefix],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantNamePrefix],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantNameLast],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantNameLast],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantNameFirst],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantNameFirst],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantNameMiddle],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantNameMiddle],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantNameSuffix],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantNameSuffix],
            RIGHT('000000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantSSN],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 9) AS [claimantSSN],
            RIGHT('00000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantDOB],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 8) AS [claimantDOB],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantSex],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantSex],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressHseNum],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantAddressHseNum],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressStreetName],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantAddressStreetName],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressAptNum],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantAddressAptNum],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressCity],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantAddressCity],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressState],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [claimantAddressState],
            RIGHT('00000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressZip],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 5) AS [claimantAddressZip],
            RIGHT('0000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantAddressZipPlus4],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 4) AS [claimantAddressZipPlus4],
            RIGHT('000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantTelephoneAreaCode],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 3) AS [claimantTelephoneAreaCode],
            RIGHT('0000000' + REPLACE(REPLACE(REPLACE(ISNULL([claimantTelephoneNumber],'0'), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' '), 7) AS [claimantTelephoneNumber],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([filler_reservedforFutureUse4],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [filler_reservedforFutureUse4],
            UPPER(REPLACE(REPLACE(REPLACE(ISNULL([clueControlArea],''), CHAR(9), ' '), CHAR(13), ' '), CHAR(10), ' ')) AS [clueControlArea],
