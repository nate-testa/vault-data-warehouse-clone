...
BEGIN
	...
	-- oDo get it from temp1
	SET @new_last_source_extract_ts=COALESCE((SELECT MAX(np_create_ts) FROM edw_temp.policy_current_carrier_auto_sj01_feed_temp1),@last_source_extract_ts);
