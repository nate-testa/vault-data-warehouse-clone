...
-- =============================================
CREATE OR ALTER PROCEDURE [edw_core].[sp_tcollection_additional_coverage]
AS
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO [edw_core].[tcollection_additional_coverage] (
			[policy_no]
           ,[effective_dt]
