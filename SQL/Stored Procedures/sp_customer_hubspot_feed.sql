...
BEGIN
	...
	BEGIN TRY
		...
		VALUES (source.[policy_no],source.[first_nm],source.[last_nm],source.[email],source.[risk_state_cd],source.[product_nm],source.[broker_id],source.[bdm_nm],source.[broker_nm],source.[broker_phone_no],source.[policy_status],source.[create_ts],source.[update_ts],source.[etl_audit_sk])
		-- For Updates
