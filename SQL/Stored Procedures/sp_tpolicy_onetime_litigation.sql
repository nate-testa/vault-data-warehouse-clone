...
BEGIN 
	...
	BEGIN TRY
        ...
        uw_company_nm,program_type,policy_status,mailing_address_line1,mailing_address_line2,mailing_address_city_nm,
        mailing_address_state_cd,mailing_address_zip_cd,mailing_address_county_nm,source_system_sk
        into edw_temp.tpolicy_onetime_litigation_temp1
        from
            (
        ...
        uw_company_nm,program_type,policy_status,mailing_address_line1,mailing_address_line2,mailing_address_city_nm,
        mailing_address_state_cd,mailing_address_zip_cd,mailing_address_county_nm,source_system_sk,create_ts,update_ts,etl_audit_sk
        )
		select policy_no,effective_dt,expiration_dt,broker_id,customer_id,product_cd,risk_state_cd,insured_nm,insured_type,
        uw_company_nm,program_type,policy_status,mailing_address_line1,mailing_address_line2,mailing_address_city_nm,
        mailing_address_state_cd,mailing_address_zip_cd,mailing_address_county_nm,source_system_sk,
