...
GO
-- ================================================================================================================================================
-- Description: This stored procedure insert and update info related to tpel_policy_lending_loss.
--------------------------------------------------------------------------------------------------------------------------------------------------
...
--
-- ================================================================================================================================================
CREATE OR ALTER PROCEDURE [edw_core].[sp_tpel_policy_lending_loss] 
AS
BEGIN
	...
	BEGIN TRY
		...
		DROP TABLE IF EXISTS [edw_temp].[tpel_policy_lending_loss_temp1];
        ...
        INTO [edw_temp].[tpel_policy_lending_loss_temp1]
        FROM (
            SELECT  
		...
		INSERT INTO [edw_core].[tpel_policy_lending_loss]
        (
            policy_no
            ,effective_dt
        ...
        FROM 
            [edw_temp].[tpel_policy_lending_loss_temp1] AS t1
        ;
		...
		SET @new_last_source_extract_ts=COALESCE((SELECT MAX(IssuedDate) FROM edw_temp.[tpel_policy_lending_loss_temp1]),@last_source_extract_ts);
