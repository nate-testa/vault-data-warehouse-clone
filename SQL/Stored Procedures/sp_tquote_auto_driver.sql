...
-- 10/23/24		Alberto Almario 		    4. Added excluded driver - AD6949
-- 11/19/24     Yunus Mohammed              5. AD7761 - Added driveruniqueid
-- =============================================
...
BEGIN
	...
	BEGIN TRY
        ...
        DROP TABLE IF EXISTS [edw_temp].[tquote_auto_driver_temp2];
        DROP TABLE IF EXISTS [edw_temp].[tquote_auto_driver_temp3];

		SELECT 
			CreatedDate, quote_no, effective_dt, expiration_dt, transaction_seq_no, driver_no, quote_history_sk, VersionObjectId,
        ...
        SELECT 
			quote_no, effective_dt, transaction_seq_no, driver_no, VersionObjectId, driver_unique_id,
        ...
        SELECT 
            ...
            t1.[ArmyNationalGuardOrAirNationalGuardPersonnelDiscount] as army_national_guard_personnel_discount_in,
        ...
        LEFT JOIN [edw_core].[tquote_auto_vehicle] taut ON taut.vehicle_unique_id = acctvo.UniqueId
                        AND taut.quote_no = t1.quote_no
                        AND taut.effective_dt = t1.effective_dt
        LEFT JOIN [edw_temp].[tquote_auto_driver_temp2] b ON t1.quote_no = b.quote_no
        ...
        SELECT
            ...
            driver_unique_id
        FROM
            [edw_temp].[tquote_auto_driver_temp3]
        ;
