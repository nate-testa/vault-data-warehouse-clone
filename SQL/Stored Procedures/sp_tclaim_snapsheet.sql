...
-- 09/23/2025		Yunus Mohammed				18. AD-11092 Added facts_of_loss
-- ======================================================================================================== 
...
BEGIN
	...
	BEGIN TRY
		...
		policy_sk,cause_of_loss_sk,loss_desc,facts_of_loss, source_claim_status,claim_status, catastrophe_sk, product_sk,
	...
	INSERT (
			...
			,policy_effective_dt,policy_sk,cause_of_loss_sk,loss_desc,facts_of_loss,claim_status
	...
	SET
		...
		Target.facts_of_loss=Source.facts_of_loss,
